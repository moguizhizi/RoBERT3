...
class EncoderLayer1(nn.Module):
    ...
    def __init__(self, size, self_attn, feed_forward, dropout):
        ...
        self.self_attn = self_attn      #多头注意力机制
        self.feed_forward = feed_forward    #前向神经网络
        self.sublayer = clones(SublayerConnection1(size, dropout), 2)
        self.size = size
...
#                 self._read_tsv(os.path.join(data_dir,'exMeSH-full-full', 'exMeSH_train.tsv')), 'train')
#
#     def get_dev_examples(self, data_dir):
#         return self._create_examples(
#             self._read_tsv(os.path.join(data_dir, 'exMeSH-full-full/', 'exMeSH_dev.tsv')), 'dev')
#
#     def get_test_examples(self, data_dir):
#         return self._create_examples(
#             self._read_tsv(os.path.join(data_dir, 'exMeSH-full-full/', 'exMeSH_test.tsv')), 'test')
#
...
#     def get_train_examples(self, data_dir):
#         return self._create_examples(
#                 self._read_tsv(os.path.join(data_dir,'Amazon', 'Electronics_train.tsv')), 'train')
#
#     def get_dev_examples(self, data_dir):
#         return self._create_examples(
#             self._read_tsv(os.path.join(data_dir, 'Amazon', 'Electronics_dev.tsv')), 'dev')
#
#     def get_test_examples(self, data_dir):
#         return self._create_examples(
#             self._read_tsv(os.path.join(data_dir, 'Amazon', 'Electronics_test.tsv')), 'test')
#
#     def _create_examples(self, lines, set_type):
#         examples = []
#         for (i, line) in enumerate(lines):
...
#     def get_train_examples(self, data_dir):
#         return self._create_examples(
#                 self._read_tsv(os.path.join(data_dir,'IMDB', 'imdb_train.tsv')), 'train')
#
#     def get_dev_examples(self, data_dir):
#         return self._create_examples(
#             self._read_tsv(os.path.join(data_dir, 'IMDB', 'imdb_dev.tsv')), 'dev')
#
#     def get_test_examples(self, data_dir):
#         return self._create_examples(
#             self._read_tsv(os.path.join(data_dir, 'IMDB', 'imdb_test.tsv')), 'test')
#
#     def _create_examples(self, lines, set_type):
#         examples = []
#         for (i, line) in enumerate(lines):
...
#     def get_train_examples(self, data_dir):
#         return self._create_examples(
#                 self._read_tsv(os.path.join(data_dir,'MIND', 'MIND_train.tsv')), 'train')
#
#     def get_dev_examples(self, data_dir):
#         return self._create_examples(
#             self._read_tsv(os.path.join(data_dir, 'MIND', 'MIND_dev.tsv')), 'dev')
#
#     def get_test_examples(self, data_dir):
#         return self._create_examples(
#             self._read_tsv(os.path.join(data_dir, 'MIND', 'MIND_test.tsv')), 'test')
#
#     def _create_examples(self, lines, set_type):
#         examples = []
#         for (i, line) in enumerate(lines):
...
class AAPDProcessor(BertProcessor):
    ...
    def get_train_examples(self, data_dir):
        return self._create_examples(
                self._read_tsv(os.path.join(data_dir,'exPFD-full-full', 'exPFD_train.tsv')), 'train')

    def get_dev_examples(self, data_dir):
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, 'exPFD-full-full', 'exPFD_dev.tsv')), 'dev')

    def get_test_examples(self, data_dir):
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, 'exPFD-full-full', 'exPFD_test.tsv')), 'test')
