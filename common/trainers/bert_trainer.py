...
class BertTrainer(object):
    ...
    def train_epoch(self, train_dataloader):
        for step, batch in enumerate(tqdm(train_dataloader, desc="Training")):
            ...
            logits = self.model(input_ids.view(-1, self.args.max_seq_length), segment_ids.view(-1, self.args.max_seq_length), input_mask.view(-1, self.args.max_seq_length))
    ...
    def train(self):
        ...
        assert len(padded_input_ids) == len(padded_input_mask) == len(padded_segment_ids) == len(label_ids)
